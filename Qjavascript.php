...
/////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    curvepoints[i].addEventListener("alongpath-trigger-activated", function(e){
                        ...
                        switch(id) {
                            ...
                            case "curveGebaude5":
                                ...
                                kamRig.emit('curveGebaude-rot-5'); 
                                break;
            ...
            document.querySelector('#fromStart2Haus').addEventListener('click', function (e) {
                    ...
                    curvepoints[i].addEventListener("alongpath-trigger-activated", function(e){
                        ...
                        switch(id) {
                            ...
                            case "curveHaus0":
                                ...
                                kamRig.emit('curveStart2haus-rot-0');
                                break;
                ...
                kamRig.emit('start2HausEasing-pos');
...
/////////////////////////////////////////////////////////////////////////////////////////////
            ...
            setTimeout(function(){
                ...
                kamRig.emit('grune2HausEasing-pos');
            ...
            setTimeout(function(){
                ...
                kamRig.emit('curveGrune2KontaktEasing');
...
/////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    curvepoints[i].addEventListener("alongpath-trigger-activated", function(e){
                        ...
                        switch(id) {
                            ...
                            case "curveGebaude2Haus1":
                                ...
                                kamRig.emit('curveGebaude2haus-rot-1'); 
                                break;
            ...
            document.querySelector('#fromGebaude2Winter').addEventListener('click', function (e) {
                ...
                kamRig.emit('frGebaude2WinterRot1');
                    ...
                    curvepoints[i].addEventListener("alongpath-trigger-activated", function(e){
                        ...
                        switch(id) {
                            ...
                            case "curveWinter2Gebaude3":
                                ...
                                kamRig.emit('curveWinter2GebaudeRot-3');
                                break;
                    ...
                    curvepoints[i].addEventListener("alongpath-trigger-activated", function(e){
                        ...
                        switch(id) {
                            ...
                            case "curveWinter2Haus0":
                                ...
                                kamRig.emit('curveWinter2HausRota-1');
                                break;
